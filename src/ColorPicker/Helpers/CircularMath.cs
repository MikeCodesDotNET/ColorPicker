...
namespace ColorPickers.Helpers
{
    /// <summary>
    ...
    internal static class MathHelpers
    {
        ...
        public static double AngleFromPoint(Point pt, Point origin)
        {
            ...
            return Mod(180.0 - (SystemMath.Atan2(dx, dy) / SystemMath.PI * 180.0));
        }
        ...
        public static Point PointFromAngle(double angle, double radius, Point origin)
        {
            ...
            double x = radius * SystemMath.Sin(angle * SystemMath.PI / 180.0);
            double y = radius * SystemMath.Cos(angle * SystemMath.PI / 180.0);
