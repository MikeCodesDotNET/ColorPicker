...
namespace ColorPickers
{
	public struct Rgb
	{
		...
		public static Rgb Default => Colors.White.ToRgb();
	...
	public struct Hsv
	{
		...
		/// <summary>
		/// Value or Brightness can be thought of as a value between 0 and 1. 
		/// </summary>
		...
		public static Hsv Default => new Hsv(360, 0, 0);
	}
	...
	public static class ConversionExtensions
    {
		...
		public static Hsv ToHsv(this string hex)
        {
			var rgb = hex.ToRgb();
			return rgb.ToHsv();
        }
		...
		public static Rgb ToRgb(this string hex)
        {
			var (rgb, a) = hex.ToRgba();
            return rgb;
		...
		// To RGBA 
		public static Tuple<Rgb, double> ToRgba(this string hex)
        {
			...
			return new Tuple<Rgb, double>(new Rgb(r / 255.0, g / 255.0, b / 255.0), a / 255.0);
		}


		//To Hex 
		public static string ToHex(this Rgb rgb, double alpha)
        {
		...
		//To Color 
		public static Color ToColor(this Rgb rgb, double alpha = 1.0)
		{
			return Color.FromArgb((byte)(alpha * 255), (byte)(rgb.R * 255), (byte)(rgb.G * 255), (byte)(rgb.B * 255));
		}
		...
		public static int ToARGB32(this Rgb rgb, double alpha = 1.0)
		{
			byte aByte = (byte)Math.Round(alpha * 255.0);
			byte rByte = (byte)Math.Round(rgb.R * 255.0);
			byte gByte = (byte)Math.Round(rgb.G * 255.0);
			byte bByte = (byte)Math.Round(rgb.B * 255.0);
			return (aByte << 24) | (rByte << 16) | (gByte << 8) | (bByte << 0);
		}

		public static int ToARGB32(this Hsv hsv)
        {
			var rgb = hsv.ToRgb();
			return rgb.ToARGB32();
        }
