...
namespace ColorPicker.ColorModels
{
    ...
    public interface IRGBWorkingSpace
    {
        ...
        /// <summary>
        ///     The companding function associated with the RGB color system. Used for conversion to XYZ and backwards. See this
        ///     for more information: http://www.brucelindbloom.com/index.html?Eqn_RGB_to_XYZ.html
