...
namespace ColorPicker.ColorModels
{
    ...
    public readonly struct HunterLabColor : IColorVector
    {
        ...
        /// <summary>
        ///     C standard illuminant. Used when reference white is not specified explicitly.
        /// </summary>
        ...
        public HunterLabColor(Vector vector, XYZColor whitePoint) : this(vector[0], vector[1], vector[2], whitePoint)
        {
        }
        ...
        /// <inheritdoc cref="object"/>
        public bool Equals(HunterLabColor other) { return L.Equals(other.L) && a.Equals(other.a) && b.Equals(other.b); }

        /// <inheritdoc cref="object"/>
        public override bool Equals(object obj) { return (obj is HunterLabColor other) && Equals(other); }
        ...
        /// <inheritdoc cref="object"/>
        public override string ToString() { return string.Format(CultureInfo.InvariantCulture, "HunterLab [L={0:0.##}, a={1:0.##}, b={2:0.##}]", L, a, b); }

        /// <summary>
        ///     a
        /// </summary>
        /// <remarks>
        ///     Ranges usually from -100 to 100. Negative values indicate green while positive values indicate magenta.
        /// </remarks>
        public double a { get; }
        ...
        /// </summary>
        /// <remarks>
        ///     Ranges usually from -100 to 100. Negative values indicate blue and positive values indicate yellow.
        /// </remarks>
        public double b { get; }
