using ColorPicker.Implementation.RGB;

namespace ColorPicker.ColorModels
{
    /// <remarks>
    ///     Chromaticity coordinates taken from: http://www.brucelindbloom.com/index.html?WorkingSpaceInfo.html
    /// </remarks>
    public static class RGBWorkingSpaces
    {
        ...
        /// <summary>
        ///     Simplified sRGB (uses <see cref="GammaCompanding"> gamma companding </see> instead of <see
        ///     cref="sRGBCompanding"/>). See also <see cref="sRGB"/>.
        /// </summary>
